	...
	function photolo_theme_customize_register( $wp_customize ) {
	    ...
	    $wp_customize->add_control('photolo_blog_page_layout', array(
	      ...
	      'choices' => array(            
	         ...
	         'grid' => __('Grid View', 'photolo'),
	         'photolo-masonry' => __('Masonry View', 'photolo'),
	         'packery' => __('Packery View', 'photolo'),
	         'fullscreen' => __('Fullscreen View', 'photolo')
	      )
	   	));

	   	$wp_customize->add_setting( 'photolo_blog_page_columns', array(
	        'default' => '4',
	        'capability' => 'edit_theme_options',
	        'sanitize_callback' => 'photolo_theme_slug_sanitize_select',
	    ) );

	   	$wp_customize->add_control('photolo_blog_page_columns', array(
	      'type' => 'select',
	      'label' => __('Choose the Blogs Page Columns', 'photolo'),
	      'section' => 'photolo_blog_archive_section',
	      'setting' => 'photolo_blog_page_columns',
	      'choices' => array(
	      		'2' => __('2', 'photolo'),            
	         	'3' => __('3', 'photolo'),
	         	'4' => __('4', 'photolo'),
	   ...
	   $wp_customize->add_setting('photolo_blog_heading_archive_section', array(
	      'default' => '5',
	      'sanitize_callback' => 'photolo_sanitize_number',
	   ));

	   $wp_customize->add_control('photolo_blog_heading_archive_section', array(
	      'type' => 'number',
	      'label' => __('Blog Heading Word Limit', 'photolo'),
	      'section' => 'photolo_blog_archive_section',
	      'setting' => 'photolo_blog_heading_archive_section',
	   ));
...
function tcx_customizer_css() {
    ...
    <style type="text/css">
        ...
        .tagcloud a:hover, .tagcloud a:focus{
			border-color: <?php echo esc_attr(get_theme_mod( 'main_theme_color' ,'#ff0000' ))?>;
			color: <?php echo esc_attr(get_theme_mod( 'main_theme_color' ,'#ff0000' ))?>;
        }
        .dropdown-item.active, .dropdown-item:active{
        	    background-color: <?php echo esc_attr(get_theme_mod( 'main_theme_color' ,'#ff0000' ))?>;
        }
